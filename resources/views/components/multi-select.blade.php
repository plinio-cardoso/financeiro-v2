    ...
    <div x-show="show" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100"
        ...
        <div class="p-2 border-b border-gray-200 dark:border-gray-700">
            <input x-model="filter" type="text" placeholder="Buscar..."
                class="block w-full px-3 py-2 text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
        </div>
